...
const IconChevronDownSmall = (
  {
    title = 'IconChevronDownSmall',
    titleId = 'CDS-IconChevronDownSmallIcon',
    size = 20,
    color = '#363738',
    ...props
...
const ForwardRef = forwardRef(IconChevronDownSmall);
export { ForwardRef as IconChevronDownSmall };
