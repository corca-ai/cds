...
export const ActiveTr = () => {
  ...
  return (
    <Table.Container>
      ...
      <Table.Tbody>
        {MOCK_DATA.map((d, index) => (
          <Table.Tr key={index.toString() + 'Items'} onClick={() => {}}>
            <Table.Td.Img src={d.img} size={size} />
            <Table.Td.Text size={size}>{d.Label1}</Table.Td.Text>
            <Table.Td.Text size={size}>{d.Label1}</Table.Td.Text>
            <Table.Td.Text size={size}>{d.Label1}</Table.Td.Text>
          ...
          <Table.Container>
            <Table.Thead>
              <Table.Tr>
                ...
                <Table.Th.Default width={FIXED_TH_WIDTH.RADIO_ITEM[th]} text=" " size={th} />
    ...
    <Table.Container>
      <Table.Thead>
        <Table.Tr>
          ...
          <Table.Th.Default width={FIXED_TH_WIDTH.RADIO_ITEM[thSize]} text=" " size={thSize} />
